...
{
       0,    87,    87,    89,    91,    92,    94,    95,    97,    98,
      99,   101,   102,   104,   105,   108,   109,   110,   111,   112,
     114,   119,   120,   122,   124,   126,   128,   129,   131,   132,
     133,   134,   135,   136,   138,   145,   147,   148,   149,   151,
     152,   160,   161,   162,   164,   165,   166,   167,   168,   169,
     171,   173
};
#endif
...
static const char *const yytname[] =
{
  ...
  "NUM", "ID", "LARGER", "$accept", "S", "bloco", "declaracao", "nome_var",
  "tipo", "comandos", "comando", "comando_combinado", "atribuicao",
  "condicional", "enquanto", "leitura", "escrita", "expressao",
  "op_relacional", "simples", "operador", "termo", "op", "fator",
...
yyreduce:
  ...
  switch (yyn)
    {
  case 2: /* S: PROG identificador SCOL bloco  */
...
#line 114 "../lib/parser.y"
                                              {if(isEmpty(lista)){
        lista = createLISTA();
  } insertNODE(lista, (yyvsp[-2].lex_value), (yyvsp[0].value));
}
...
#line 126 "../lib/parser.y"
                                               { printf("%d\n", getValue(lista, (yyvsp[-1].lex_value)));}
...
#line 164 "../lib/parser.y"
                              { (yyval.value) = getValue(lista, (yyvsp[0].lex_value));}
#line 1473 "parser.tab.c"
    break;

  case 45: /* fator: numero  */
#line 165 "../lib/parser.y"
                         {  (yyval.value) = (yyvsp[0].value);}
#line 1479 "parser.tab.c"
    break;

  case 46: /* fator: OPPAR expressao CLPAR  */
#line 166 "../lib/parser.y"
                                        {(yyval.value) = (yyvsp[-1].value);}
#line 1485 "parser.tab.c"
    break;

  case 47: /* fator: TRUE  */
#line 167 "../lib/parser.y"
                       {}
